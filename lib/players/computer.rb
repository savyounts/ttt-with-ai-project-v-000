...
class Computer < Player
  ...
  def move(board)
    ...
    def defend_fork
      case opponent_forks
        when (board.cells[0] != player.token || board.cells[0] != " ")&& (board.cells[0] == board.cells[2] || board.cells[0] == board.cells[6] || board.cells[8] == board.cells[6] || board.cells[8] == board.cells[2])
           "4"
        when board.cells[0] == player.token && (board.cells[0] == board.cells[4] ||board.cells[8] == board.cells[4]
          ["2", "6"].sample
        when board.cells[2] == player.token && (board.cells[4] == board.cells[2] || board.cells[4] == board.cells[6])
